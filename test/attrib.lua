...
--assert(type(package.cpath) == "string")   -- C Libraries not supported
...
do  print"testing 'require' message"
  ...
  local expected = [[module 'XXX' not found:
	...
	no file 'XXX.lua'
	no file 'XXX/XXX']]   -- EDIT: C Libraries not supported
...
for t in string.gmatch(package.path, "[^;]+") do   -- Edit from original test: C Libraries not supported
...
---- testing require of C libraries   -- C Libraries are not supported
--
--
